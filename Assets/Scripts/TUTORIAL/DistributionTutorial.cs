...
public class DistributionTutorial : MonoBehaviour {
    ...
    {
        Monkeys[Random.Range(0, 19)].GetComponent<MonkeyTutorial>().SetChosen(BigButtonPrefab);
        //for (int k = 0; k < 1; k++)
        //{
    ...
    public void DisableAll()
    {
        for (int k = 0; k < 19; k++)
        {
            Monkeys[k].GetComponent<MonkeyTutorial>().SetNotChosen();
        }
    }
