...
public class DistributionUltra : MonoBehaviour {
    ...
    {
        Monkeys[Random.Range(0, 19)].GetComponent<MonkeyUltra>().SetChosen(BigButtonPrefab);
        //for (int k = 0; k < 1; k++)
        //{
    ...
    public void DisableAll()
    {
        for (int k = 0; k < 19; k++)
        {
            Monkeys[k].GetComponent<MonkeyUltra>().SetNotChosen();
        }
    }
